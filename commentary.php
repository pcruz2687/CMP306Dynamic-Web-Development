...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<p><img class="img-fluid" src="view/images/ERD.jpg" style="height:650px;width:650px;"></p>
					<h5>Issues</h5>
					...
					<p><img class="img-fluid" src="view/images/week3-commentary.jpg"></p>
					...
					<p><img class="img-fluid" src="view/images/week5-commentary-pattern.jpg"></p>
					...
					<p><img class="img-fluid" src="view/images/week5-commentary-controller.jpg"></p>
					...
					<p><img class="img-fluid" src="view/images/week5-commentary-function.jpg"></p>
					...
					<p><img class="img-fluid" src="view/images/week5-commentary-parameter.jpg"></p>
					...
					<p><img class="img-fluid" src="view/images/week6-commentary-flow.jfif"></p>
					...
					<p><img class="img-fluid" src="view/images/week7-commentary-device.JPG"></p>
					<strong>Agent Code</strong>
					<p><img class="img-fluid" src="view/images/week7-commentary-agent.JPG"></p>
					<strong>PHP Code</strong>
					<p><img class="img-fluid" src="view/images/week7-commentary-php.JPG"></p>
					<strong>Database</strong>
					<p><img class="img-fluid" src="view/images/week7-commentary-reading.JPG"></p>

					<h3>Week 8</h3>
					<p><img class="img-fluid" src="view/images/week8-commentary-diagram.JPG"></p>
					...
					<p><img class="img-fluid" src="view/images/week8-commentary-db.jpg"></p>
					...
					<p><img class="img-fluid" src="view/images/week10-commentary-rss.jpg"></p>
					...
					<h3>Week 11</h3>
					<p><img class="img-fluid" src="view/images/week11-commentary-xsl.JPG"></p>
					...
					<p><img class="img-fluid" src="view/images/week11-commentary-xsl-2.JPG"></p>
